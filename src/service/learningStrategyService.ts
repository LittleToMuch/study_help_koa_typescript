...
export const insertLearningStrategy = async (params: LearningStrategy) => {
  try {
    ...
    const inserSQL: string = `insert into learningstrategy (title, content, createDate, category, pic, userid, del) values ('${title}', '${content}', '${createDate}', '${category}', '${pic}', '${userid}', 0)`;
